...
from utils.replay_buffer_qpa import ReplayBufferQPA
from utils.logger import Logger
import hydra
from reward_model.qpa_reward_model import RewardModelQPA
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.replay_buffer = ReplayBufferQPA(self.env.observation_space.shape,
        ...
        self.step = 0
        self.video_record_path = cfg.video_record_path
        if self.video_record_path:
            os.makedirs(self.video_record_path, exist_ok=True)
            
        self.reward_model = RewardModelQPA(self.env.observation_space.shape[0],
    ...
    def evaluate(self):
        ...
        for ep in range(self.cfg.num_eval_episodes):
            ...
            while not done:
                ...
                if self.video_record_path and (self.step in list(range(450000, 510000)) + (list(range(950000, 1000000)))):
        ...
        while self.step < self.cfg.num_train_steps:
            ...
            if self.step == (self.cfg.num_seed_steps + self.cfg.num_unsup_steps):
                ...
                if (self.total_feedback < self.cfg.max_feedback):
                    ...
                    self.agent.update_onpolicy_sample(self.replay_buffer, self.logger, self.step, size, gradient_update=1, her_ratio=self.cfg.her_ratio)
                else:
...
@hydra.main(config_path='config', config_name='train_QPA', strict=True)
def main(cfg):
